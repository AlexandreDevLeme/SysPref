...
echo "<div class='container'>
    <div class='folha'>";
        ...
        echo "
        <br>
            <div class='linha-fx'>Antiga Rua _____________________________________________________________________________________ </div>
            <div class='linha-fx'>Atual Rua ______________________________________________________________________________________ </div>
            <div class='linha-fx'>Bairro ___________________________________ </div>";
        ...
        echo "
            <br>    
            <label>Obs.:</label>
            <div class='denrua_print'>$denominar->den_Obs</div>
        ";

        echo "<div class='campoDocDR'>";
