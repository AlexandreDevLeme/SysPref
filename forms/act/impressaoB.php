...
cabecalho("IMPRESSÃO DE REQUERIMENTOS","../css/impressaoB.css");
...
echo "<div class='container'>
    ...
    echo "<div class='doc_print'>Vem mui respeitosamente solicitar ao Núcleo de Cadastro Imobiliário que seja expedida a Certidão de <label class='varDoc'>$documento</label> do imóvel abaixo:</div>";
    ...
    echo "<div class='identific'>id Req. $_id  -  $_op</div><br>";
