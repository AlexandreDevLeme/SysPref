...
echo "
        <div class='dados-desd background3'>
            ...
            <div class='input-group input-group-sm mb-0 inp8 position-static'>
                ...
                <input type='text' id='ncad3' name='ncad3' size='16' maxlength='16' class='form-control q3desde position-static' aria-label='Sizing example input' aria-describedby='inputGroup-sizing-sm'>
