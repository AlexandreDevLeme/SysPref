...
cabecalho("Certidão de Ficha Cadastral", "../css/formularios.css");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/certFichaCad.php";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2FichaC'><h4>PREENCHIMENTO DE CERTIDÃO DE FICHA CADASTRAL</h4></td>
...
echo "
    <div class='dados-fichaC background3'>  
        <div class='input-group input-group-sm mb-0 inp9 position-static'>
                <H4 id='titu-FC'class='position-static'>Dados Complementares da Ficha Cadastral</H4>
    ...
    <input type='text' id='motivo' name='className' value='FICHA CADASTRAL' class='motivo'></input>
