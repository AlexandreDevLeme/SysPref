...
cabecalho("B.C.I - Boletin de Cadastro Imobiliário", "../css/formularios.css", "");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/bci.php";
...
";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Bci'><h4>PREENCHIMENTO DE CERTIDÃO DE B. C. I. - BOLETIM DO CADASTRAMENTO DE IMÓVEL </h4></td>
    ...
    echo "
            <div class='dadosBci background3'>
                <div id='buttonBCI' class='input-group input-group-sm mb-0 position-static'>   
                    <button type='button' class='btn btn-outline-light' onClick=\"Print_Sub()\">IMPRIMIR</button>
                </div>
            </div>
            <input type='text' id='motivo' name='className' value='B.C.I. (BOLETIM DO CADASTRAMENTO DE IMÓVEL)' class='motivo'></input>
        </form>
    ";
echo "
    </div>
