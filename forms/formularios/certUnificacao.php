...
cabecalho("Certidão de Unificação", "../css/formularios.css");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/certUnificacao.php";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Unif'><h4>PREENCHIMENTO DE CERTIDÃO DE UNIFICAÇÃO</h4></td>
...
echo "
        ...
        <input type='text' id='motivo' name='className' value='RENOVAÇÃO DE CERTIDÃO DE UNIFICAÇÃO' class='motivo'></input>
    </form>
";
echo "
    </div>
