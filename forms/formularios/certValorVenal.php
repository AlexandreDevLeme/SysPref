...
cabecalho("Certidão de Valor Venal", "../css/formularios.css");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/certValorVenal.php";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Vv'><h4>PREENCHIMENTO DE CERTIDÃO DE VALOR VENAL</h4></td>
        ...
        <form id='Submit_Print' action='../act/impressaoE.php' method='post' class='form-control-inline'>
            <div class='reg_requerente background1'><!--Abertura da div requerente-->
                ...
                <div class='input-group input-group-sm mb-0 title1 position-static'>
                    ...
                    <input type='text' id='nome' name='nomeR' value='$nome' class='form-control i1 position-static' aria-label='Sizing example input' aria-describedby='inputGroup-sizing-sm' placeholder=''>
                </div>
...
echo "
        <div class='dados-Vv background3'>
            <div class='input-group input-group-sm mb-0 inp8 position-static'>
                <div>
                    <H4 class='titu-Vv position-static'>Dados para Valor Venal</H4>
                </div> 
        ...
        <input type='text' id='motivo' name='className' value='VALOR VENAL' class='motivo'></input>
    </form>
";
echo "
    </div>
