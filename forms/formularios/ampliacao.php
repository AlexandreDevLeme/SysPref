...
cabecalho("Ampliação", "../css/formularios.css", "");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/ampliacao.php";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Ampl'><h4>PREENCHIMENTO DE CERTIDÃO DE AMPLIAÇÃO</h4></td>
...
echo "
        <div class='dadosAmpl background3'>
            <div class='input-group input-group-sm mb-0 title3 position-static'>
                <H4 class='titu-ampl position-static'>Dados do alvará</H4>
            </div>
