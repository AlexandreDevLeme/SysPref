...
cabecalho("Cancelamento de Alvará", "../css/formularios.css", "");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/cancelamentoAlvara.php";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Canc'><h4>PREENCHIMENTO DE CERTIDÃO DE CANCELAMENTO DE ALVARÁ</h4></td>
...
echo "
        <div class='cancAl background3'>
            <div class='input-group input-group-sm mb-0 cancelamentoAlvara position-static'>
                
                    <H4 class='titu-cancAl position-static'>Dados do alvará cancelado</H4>
                    <div><button type='button' class='btn btn-outline-light' onClick=\"Print_Sub()\">IMPRIMIR</button></div>
            ...
            <div class='input-group input-group-sm mb-0 inp11 position-static'>
                ...
                <input type='text' id='motivo' name='className' value='CANCELAMENTO DE ALVARÁ' class='motivo'></input>
        </div>
    </form>
";
echo "
