...
cabecalho("Certidão de Demolição", "../css/formularios.css", "");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/certDemolicao.php";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Dem'><h4>PREENCHIMENTO DE CERTIDÃO DE DEMOLIÇÃO</h4></td>
...
echo "
        <div class='dadosDem background3'>
            <div class='input-group input-group-sm mb-0 inp9 position-static'>
                <div>
                    <H4 class='titu-Dem position-static'>Dados da Demolição</H4>
                </div>
            </div>  
            ...
            <input type='text' id='motivo' name='className' value='DEMOLIÇÃO' class='motivo'></input>
        </div>
    </form>
";
echo "
