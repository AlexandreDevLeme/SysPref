...
cabecalho("Emplacamento", "../css/formularios.css", "");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/certEmplacamento.php";
...
";
    echo "
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Emp'><h4>PREENCHIMENTO DE CERTIDÃO DE EMPLACAMENTO</h4></td>
        ...
        <form id='Submit_Print' action='../act/impressaoD.php' method='post' class='form-control-inline'>
...
echo "
        <div class='dados-emp background3'>
            <div class='input-group input-group-sm mb-0 inp9 position-static'>
                <div>
                    <H4 class='titu-Emp position-static'>Dados do Emplacamento</H4>
                </div>
            </div>
