...
cabecalho("Certidão de Lado do Imóvel", "../css/formularios.css");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/certLadodoImovel.php";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Ladoim'><h4>PREENCHIMENTO DE CERTIDÃO DE LADO DO IMÓVEL</h4></td>
...
echo "
        <div class='dados-ladoi background3'>
            <div class='input-group input-group-sm mb-0 inp9 position-static'>
                <h4 class='titu-mladoI position-static'>Dados da Certidão de lado do imóvel</h4>
        ...
        <input type='text' id='motivo' name='className' value='LADO' class='motivo'></input>
    </form>
";
echo "
    </div>
