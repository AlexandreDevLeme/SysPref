...
cabecalho("Certidão de Medição/Verificação In Loco", "../css/formularios.css");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/certMedInLoco.php";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Mloco'><h4>PREENCHIMENTO DE CERTIDÃO DE MEDIÇÃO IN LOCO</h4></td>
...
echo "
        <div class='dados-mloco background3'>
            <div class='input-group input-group-sm mb-0 inp9 position-static'>
                <h4 class='titu-mloco position-static'>Dados da Medição/Verificação In Loco</h4>
        ...
        <input type='text' id='motivo' name='className' value='MEDIÇÃO / VERIFICAÇÃO \"IN LOCO\"' class='motivo'></input>
    </form>
";
echo "
    </div>
