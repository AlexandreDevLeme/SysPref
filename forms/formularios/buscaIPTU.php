...
require "../func/permLink.php";

session_start();

cabecalho("Certidão de buscas de IPTU", "../css/formularios.css");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/buscaIPTU.php";
...
";
            ...
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2BuscaI'><h4>PREENCHIMENTO DE CERTIDÃO DE BUSCAS DE IPTU</h4></td>
    ...
    echo "
            <div class='buscaIP background3'>
                
                    <H4 class='titu-buscaIPTU position-static'>Dados para Busca de IPTU</H4>                        
                    <br>
                <div id='divBUSCA' class='input-group input-group-sm mb-0'>    
                    <span class='input-group-text position-static' id='inputGroup-sizing-sm'>Ano</span>
                    <input type='text' id='anoBuscaI' name='anoBuscaI' value='$ano' size='16' maxlength='4' class='form-control f1 position-static' aria-label='Sizing example input' aria-describedby='inputGroup-sizing-sm'>
                    <button type='button' id='btnBIPTU' class='btn btn-outline-light' onClick=\"Print_Sub()\">IMPRIMIR</button>
                </div>
            </div>
            <input type='text' id='motivo' name='className' value='BUSCAS DE IPTU' class='motivo'></input>
        </form>
    ";
echo "
    </div>
