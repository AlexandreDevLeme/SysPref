...
cabecalho("Certidão de Contrução e Habite-se", "../css/formularios.css", "");
/*########################################################################################*/
...
$_SESSION['target'] = "../formularios/certConstrucao_habite_se.php";
...
";
    echo "
            <div class='menuSuperior'><!--Botão de acesso ao menu lateral e titulo da tela principal-->
                <table>
                    <tr>
                        ...
                        <td id='t2Habit'><h4>PREENCHIMENTO DE CERTIDÃO DE CONSTRUÇÃO E/OU HABITE-SE</h4></td>
        ...
        <form id='Submit_Print' action='../act/impressaoB.php' method='post' class='form-control-inline'>
...
echo "
        <div class='habit background3'>
            <div class='input-group input-group-sm mb-0 inp9 position-static'>
                <H4 class='titu-Habit position-static'>Dados da Certidão de Construção/Habite-se</H4>
