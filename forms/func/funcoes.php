...
{echo "<!DOCTYPE html>
    ...
    <head><!--Itens do head e scripts-->
        ...
        <script type='text/javascript'><!--Funções limpeza de boxes e submits-->
            ...
            function Submit_Capture(){
                if (document.getElementById(\"text\").value == \"\")
                {
                    alert('Está função só funciona se um filtro estiver marcado.');
                }else{
        ...
        <script type='text/javascript'>
        function marcarChecks1(){
            document.getElementsByName(\"con_hab_chk2\") = 'Unchecked';            
        }
        function marcarChecks2(){
            document.getElementsByName(\"con_hab_chk1\") = 'UnChecked'; 
        }
        </script>
    </head>
