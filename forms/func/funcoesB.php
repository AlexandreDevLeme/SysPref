    ...
    <head><!--Itens do head e scripts-->
        ...
        <script type='text/javascript'><!--Verificação e confirmação do preenchimento dos campos-->
            function Print_Sub()
            {
                if (document.getElementById('nome').value == \"\"){
                    ...
                    if (redirecionar == true) {
                        if (document.getElementById('campoS').value == \"\"){
                            alert(\"Você precisa selecionar o motivo do atendimento para continuar com a impressão.\");
                ...
                }else if (document.getElementById('carne').value == \"\"){
                    var redirecionar = confirm(\"Há campos não preenchidos. \u000ADeseja continuar?\");
                    if (redirecionar == true) {
                        if (document.getElementById('campoS').value == \"\"){
                            alert(\"Você precisa selecionar o motivo do atendimento para continuar com a impressão.\");
